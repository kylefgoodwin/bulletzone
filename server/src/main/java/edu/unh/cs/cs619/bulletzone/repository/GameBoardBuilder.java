...
//        gameBoard = new GameBoard(width, height);
    ...
    public void setupGame(Game game) {
        ...
        //Terrain test cells
        game.getHolderGrid().get(115).setTerrainEntityHolder(new Terrain(1));
        game.getHolderGrid().get(118).setTerrainEntityHolder(new Terrain(2));
        game.getHolderGrid().get(121).setTerrainEntityHolder(new Terrain(3));
    }
